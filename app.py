...
def run_web():
    # ৫০০০ পোর্ট ব্যবহার করে ওয়েব সার্ভার চালু
    try:
...
if __name__ == "__main__":
    logger.info("Starting 24x7 JUBAYER Hosting Bot System...")
    
    # থ্রেড ১: ওয়েব ড্যাশবোর্ড চালু করা
    t = threading.Thread(target=run_web)
    t.daemon = True
    t.start()
    
    # থ্রেড ২: টেলিগ্রাম বট চালু করা (মেইন থ্রেড)
    start_bot()
